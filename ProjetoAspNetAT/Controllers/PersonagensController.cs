...
namespace ProjetoAspNetAT.Controllers
{
    public class PersonagensController : Controller
    {
        ...
        public PersonagensController(ProjetoAspNetATContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Personagens != null ? 
                          ...
                          Problem("Entity set 'ProjetoAspNetATContext.Personagens'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Idade,Descricao,Criacao")] Personagens personagens)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Idade,Descricao,Criacao")] Personagens personagens)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoAspNetATContext.Personagens'  is null.");
            }
            var personagens = await _context.Personagens.FindAsync(id);
            if (personagens != null)
            {
